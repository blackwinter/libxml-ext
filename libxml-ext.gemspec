...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/libxml/ext/string_representation.rb", "lib/libxml/ext/enhanced_find.rb", "lib/libxml/ext/version.rb", "lib/libxml/ext/uniqueness.rb", "lib/libxml/ext/namespaces.rb", "lib/libxml/ext.rb", "README", "ChangeLog", "Rakefile", "COPYING", "spec/libxml/ext_spec.rb", "spec/spec_helper.rb"]
